 ...
 * $Id: cdrom.h 13905 2006-01-12 23:10:04Z dionoea $
 *
 ...
 * Prototypes
 *****************************************************************************/
vcddev_t *ioctl_Open         ( const char * );
void      ioctl_Close        ( vcddev_t * );
int       ioctl_GetTracksMap ( const vcddev_t *, int ** );
int       ioctl_ReadSectors  ( const vcddev_t *, int, byte_t *, int, int );
int       GetCDList          ( LPCDLIST );

...
// Play content enum
CPlayer.CONTENT_VIDEO = 0;
CPlayer.CONTENT_SWF = 1;
CPlayer.CONTENT_AUDIO = 2;
CPlayer.CONTENT_IMAGE = 3;
CPlayer.CONTENT_OTHER = 4;
...
CPlayer.prototype.hasAudio = function() {
    return this.m_plugin.getInfo(CPlayer.PLAYER_HAS_AUDIO, this.m_playerIndex);
};

CPlayer.prototype.hasVideo = function() {
    return this.m_plugin.getInfo(CPlayer.PLAYER_HAS_VIDEO, this.m_playerIndex);
};

CPlayer.prototype.getPercentage = function() {
    var ret = null;
    if(this.m_playerState == CPlayer.PLAYER_PLAYING) {
        ret = this.m_plugin.getInfo(CPlayer.PLAYER_PERCENTAGE, this.m_playerIndex);
    }
    return ret;
};
...
CPlayer.prototype.setVolume = function(volValue) {
    var cmdStr = "volume " + volValue + " 1";
    this.sendCommand(cmdStr, false);
};
CPlayer.prototype.getVolume = function() {
    return this.sendCommand("get_property volume", true);
};

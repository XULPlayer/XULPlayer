...
CPlayer.PLAYER_ENTRY = 1;
CPlayer.PLAYER_PLAYING = 2;
CPlayer.PLAYER_PAUSED = 3;	
CPlayer.PLAYER_STOPPING = 4;
...
CPlayer.prototype.playDevice2 = function(dvdCmd) {
	...
	//this.m_plugin.bgColor = 0x333331;
...
CPlayer.prototype.setEnableMultiMode = function(bEnableMulti) {
	this.m_plugin.setEnableMultiMode(bEnableMulti);
};
...
CPlayer.prototype.playLoop = function() {
	this.m_playerIndex = this.m_plugin.activeId;
